# InfraTales | Knowledge Graph – Neptune Graph Database on AWS

**Production-ready reference architecture for knowledge graphs with fraud detection and recommendations.**
